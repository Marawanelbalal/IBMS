...
//    Account acc1("USD", "John Doe", 500.0, 12345);
//    Account acc2("USD", "John Doe", 1000.0, 67890);
//    Account acc3("USD", "John Doe", 150.0, 11111);
//
//    // Create a customer
//    Customer customer1("John Doe", "123 Main St", 1234567890);
//    Customer customer2("John Doe", "123 Main St", 1234567890);
//
//
